...
- Use the sidebar **Dashboard mover count** selector to switch between the default **Top 10** and **Top 20**. The selection applies to current movers, historical monthly lists, rotation analysis, details, breakouts, and PDF snapshots. Run the setup script once after deploying this change to populate 20-row cache data.
